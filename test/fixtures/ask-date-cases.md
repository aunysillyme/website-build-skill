...
| 7 | An active prompt, playbook, checklist or role file contains `research 2025-2026 award winning website designs`. | AD08: hardcoded recency in active content fails. The identical string inside `archive/graphics-design-original.md` or a bounded verbatim public-post quote is correct to retain and must NOT be flagged; those contexts alone are exempt. |
