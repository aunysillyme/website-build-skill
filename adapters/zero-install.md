...
Paste this self-contained starter into an AI chat. It needs no repository retrieval, clone or npm.
It establishes the first task; attach the full bundles for the complete method.
...
Paste or attach [method](../docs/bundles/method.md), [prompts](../docs/bundles/prompts.md), [playbooks](../docs/bundles/playbooks.md), [checklists](../docs/bundles/checklists.md) and [team](../docs/bundles/team.md).
They exist locally and in the public repository: browse [the bundle folder](https://github.com/aunysillyme/website-build-skill/tree/main/docs/bundles), download [the main archive](https://github.com/aunysillyme/website-build-skill/archive/refs/heads/main.zip), or open a raw file such as
`https://raw.githubusercontent.com/aunysillyme/website-build-skill/main/docs/bundles/method.md`.
Retrieval serves the files; a host bootstrapping itself from a URL is UNVERIFIED.
Never substitute a similar repository when retrieval fails. Pin one revision and verify manifest hashes before combining files.
Without retrieval, supply the text itself. A URL alone is not loaded knowledge.
